...
class Compose:
    """
    Alternative Compose class for Custom dataset which composes several augmentations together
    Args:
        input data: image, boxes, labels
        transform (List[Transform]): list of transforms approach to compose
    Returns:
    """
...
class Transform():
    def __init__(self, is_train=True, size=(512,512), mean=(0.485, 0.456, 0.406), var=(0.229, 0.224, 0.225)):
        self.mean = mean
        self.size = size
